...
# It's interesting that R starts with 1 than 0.
...
# I think this vectors has character counts! nchar -> number of characters?
...
# So R does things for each and everything. That means it doesn't need a for loop eh. 
...
# The str gives the columns of values.

# The dim just tells you how many rows, and how many columns. 
...
# variable.
# So in R, they call columns variables. 
